...
CREATE TABLE "Like" (
    ...
    CONSTRAINT "Like_pkey" PRIMARY KEY ("postId","senderId")
);
...
-- AddForeignKey
ALTER TABLE "Following" ADD CONSTRAINT "Following_followeeId_fkey" FOREIGN KEY ("followeeId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
